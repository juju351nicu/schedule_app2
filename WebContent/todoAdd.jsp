...
<table class="table">
		...
		<tr>
			<th>日付(date_from)</th>
			<td><input type="date" name="date_from" size="10" value="${dto.date_from}"  /></td>
		</tr>
		<tr>
			<th>日付(date_to)</th>
			<td><input type="date" name="date_to" size="10" value="${dto.date_to}"  /></td>
		</tr>
		<tr>
			<th>タイトル</th>
			<td><input type="text" name="title" size="10" value="${dto.title}"  /></td>
		</tr>
		<tr>
			<th>詳細</th>
			<td><textarea rows="20" cols="20" name="detail" >${dto.detail}</textarea></td>
		</tr>
		<tr>
		<th>Done_flag</th>
		<td>
